...
import { delayQuerySelector } from '../../util/comp'

export default class CustomAtAccordion extends React.Component<
  any,
  any
> {
    ...
    return (
      <View className={rootCls} style={customStyle}>
        <View className={headerCls} onClick={this.handleClick}>
          ...
          <View className='at-accordion__header_content'>{this.props.body}</View>
...
CustomAtAccordion.defaultProps = {
  open: false,
  customStyle: '',
  className: '',
  title: '',
