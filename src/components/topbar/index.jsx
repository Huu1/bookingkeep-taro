...
class NavBar extends Component {
  ...
  static defaultProps = {
    extClass: "",
    // background: "linear-gradient(90deg,#ffa15b, #ff7954)", //导航栏背景
    background: "#ffda44", //导航栏背景
    color: "#000000",
    title: "",
    searchText: "点我搜索",
    searchBar: false,
  ...
  render() {
    ...
    return (
      <View
        ...
        };height:${navBarHeight + navBarExtendHeight + extraHeight}px;`}
      >
        <View
